...
export const grade12: JourneyEvent[] = [
  ...
  {
    id: "g12-wp1", grade: 12, type: "waypoint", label: "Section exam 1", short: "EOC 1",
    week: 5, phase: "coreA", semester: 1, track: "tahsili",
    summary: "First EOC — covers all Tahsili subjects (Biochem, Physics, Math).",
    detail: "End of the first teaching block. A combined section exam covering all re-taught subjects: Biochem, Physics, and Math.",
    covers: "Biochem · Physics · Math",
  },
  {
    id: "g12-wp2", grade: 12, type: "waypoint", label: "Section exam 2", short: "EOC 2",
    week: 11, phase: "coreA", semester: 1, track: "tahsili",
    summary: "Second EOC — covers all Tahsili subjects (Biochem, Physics, Math).",
    detail: "End of the second teaching block. A combined section exam covering all re-taught subjects: Biochem, Physics, and Math.",
    covers: "Biochem · Physics · Math",
  },
  {
    id: "g12-wp3", grade: 12, type: "waypoint", label: "Section exam 3", short: "EOC 3",
    week: 17, phase: "coreB", semester: 1, track: "tahsili",
    summary: "Third EOC — covers all Tahsili subjects (Biochem, Physics, Math).",
    detail: "Final S1 section exam covering all re-taught subjects: Biochem, Physics, and Math. Sat in the last teaching week before the school finals fortnight.",
    covers: "Biochem · Physics · Math",
  },
  {
